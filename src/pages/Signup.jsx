...
const Signup = () => {
  ...
  return (
    <div className="bg-linear-to-b from-red-50 to-green-100 min-h-screen flex flex-col p-8 justify-center items-center ">
      <div className="md:bg-white md:p-8 rounded-2xl md:shadow-lg  md:w-[80%] flex  gap-6 md:gap-16 md:flex-row flex-col">
        <div className="w-full">
          <div className="py-4">
            <h3 className="text-3xl font-semibold">Create Account</h3>
            <p className="text-sm text-black">
              Join <span className="text-green-950">Regent hub</span> Job
              Placement System
            </p>
          </div>
          ...
          <form onSubmit={handleSignup} className="flex flex-col ">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="border-2 border-gray-400 w-full p-2 rounded-xl my-2 mb-3 pl-9"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="border-2 border-gray-400 w-full p-2 rounded-xl my-2 pl-9"
              />
            </div>
        ...
        <div className="hidden md:flex flex-col text-center capitalize items-center justify-center bg-green-300/10 w-full px-7">
          <img
          ...
          <h1 className="text-5xl font-medium mb-10">
            regent <span className="text-red-900">hub</span>
          </h1>
          <img
