        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <div className="hidden md:flex items-center justify-between px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-200">
                ...
                <div className="flex items-center space-x-4">
                    <button 
                        onClick={() => setShowNewMessageModal(true)}
                        className="bg-green-100 text-green-900 px-4 py-2 rounded-xl font-semibold hover:bg-green-200 transition-all duration-300 flex items-center space-x-2"
                    >
                ...
                <div className={`${activeChat ? 'flex' : 'hidden md:flex'} flex-1 flex-col bg-white`}>
                    {activeChat ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                            ...
                            <button 
                                onClick={() => setShowNewMessageModal(true)}
                                className="bg-gradient-to-r from-green-900 to-green-800 hover:from-green-800 hover:to-green-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 flex items-center space-x-2"
                            >
                                <FaEdit className="w-4 h-4" />
