  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-linear-to-b from-red-50 to-green-100">
      <div className="bg-white p-8 rounded-2xl shadow-md w-[90%] sm:w-[400px]">
        <h2 className="text-2xl font-semibold text-center text-green-950 mb-4">
          Set a New Password
        </h2>
        <form onSubmit={handleUpdate}>
          ...
          {message && <p className="text-green-950 text-sm">{message}</p>}

          <button
            type="submit"
            className="bg-green-950 text-white w-full mt-4 py-2 rounded-md hover:bg-green-800"
          >
            Update Password
          </button>
        </form>
